    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-9 col-sm-12"><!-- left text -->
          <h3>Si deseas proseguir con la restauracion <span><strong>Presiona el boton</strong></span> </h3>
        ...
        <div class="col-md-3 col-sm-12 text-right"><!-- right btn -->
          <form action="/elproyecto/public/Prestador/suspender/{{$suspe->id}}" method="POST" role="form">
            {{ csrf_field() }}
            <button type="submit" class="btn btn-danger btn-lg"><i class="fa fa-check"></i> Restaurar </Button>
          </form>
        </div><!-- /right btn -->
