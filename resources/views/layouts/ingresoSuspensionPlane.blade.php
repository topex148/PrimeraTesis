...
<div class="container">
	<header class="text-center mb-60">
		<h2>Lista de Planes Suspendidos</h2>
		<p class="lead font-lato">Esta es la lista de los planes suspendidos en el sistema.</p>
		<hr />
	</header>
