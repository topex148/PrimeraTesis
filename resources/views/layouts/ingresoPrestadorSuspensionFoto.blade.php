          ...
          <div class="box-inner">
            ...
            <div class="container">
            	<header class="text-center mb-60">
            		<h2>Lista de Fotos Suspendidas</h2>
            		<p class="lead font-lato">Esta es la lista de las fotos suspendidas en el sistema.</p>
            		<hr />
            	</header>
            <table class="table table-hover">
            	...
            	<tbody>
            	@foreach ($fotos as $suspe)
              @if (($suspe->RIF_Prest) == ($note->RIF))
            	<tr>
            		<td>
            				<img src="{{asset('storage/imagen/foto/'.$suspe->imagen)}}" style="width:75px; height:75px; float:left; border-radius:50%; margin-right:25px;">
            		</td>
            		<td>
            				<a>{{$suspe->id}} </a>
            		</td>
