<!-- CONTACT -->
            ...
            <form action="/elproyecto/public/Plane/{{$note ->id}}" method="POST" role="form">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <h5>Publicidad</h5>
                      <select required type="text" value="{{$note->Publicidad}}" class="form-control select2" name="Publicidad" placeholder="Ingrese la Publicidad" >
      ...
      <!-- BUTTON CALLOUT -->
      <a href="/elproyecto/public/Plane" rel="nofollow" class="btn btn-xlg btn-warning fs-20 fullwidth m-0 rad-0 p-40">
