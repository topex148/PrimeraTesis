			...
			<section id="contact">
                ...
                {{csrf_field()}}
							  ...
							  <!--<fieldset>-->
									...
									<div class="row">
										...
										<div class="col-md-4"><!-- select -->
											<label for="">RIF</label>
												<select class="form-control" name="RIF_4" value="{{$note->RIF_4}}">
														<option value="{{$note->RIF_4}}">--- Seleccione el RIF del prestador ---</option>
										...
										<!--
											...
											<div class="col-md-4"><!-- select -->
												<label for="">Id de paquete</label>
													<select class="form-control" name="id_P_3" value="{{$note->id_P_3}}">
															<option value="{{$note->id_P_3}}">--- Seleccione el id del paquete ---</option>
											...
											<div class="col-md-4"><!-- select -->
												<label for="">Numero de cliente</label>
													<select class="form-control" name="id_Cliente_1" value="{{$note->id_Cliente_1}}">
															<option value="{{$note->id_Cliente_1}}">--- Seleccione el numero de cliente ---</option>
                    ...
                    <div class="col-md-6">
                      ...
                      <!-- date picker -->
                      <input required type="text" value="{{$note->Fecha_Inicio}}" class="form-control datepicker" name="Fecha_Inicio" data-format="yyyy-mm-dd" data-lang="en" data-RTL="false" placeholder="Ingrese la Fecha de Inicio">
                    ...
                    <div class="col-md-6">
                      <h5>Fecha Final</h5>
                      <!-- date picker -->
                      <input required type="text" value="{{$note->Fecha_Final}}" class="form-control datepicker" name="Fecha_Final" data-format="yyyy-mm-dd" data-lang="en" data-RTL="false" placeholder="Ingrese la Fecha Final">
